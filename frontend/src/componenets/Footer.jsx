      ...
      <div className="row p-4 text-center ">
        ...
        <div className='col-lg-4 col-md-4 col-sm-12 mb-2' >
          ...
          <div className='d-flex flex-column'>
            <p><i className="px-1 fa-sharp fa-solid fa-location-dot"></i> 99 John Doe Street</p>
            <p>Lorem Ipsum</p>
            <p>Lorem Ipsum - 999999</p>
            <p><i className="px-1 fa-solid fa-phone-volume"></i> +91-999999999</p>
          </div>
        </div>
      </div>
    </div>
